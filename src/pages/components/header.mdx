...
import excelchatHeader from 'src/examples/Header/excelchat';
import excelchatLoginHeader from 'src/examples/Header/excelchat_login';
import excelchatWorkspaceHeader from 'src/examples/Header/excelchat_workspace';
...
<CodeView transparentBackground codeText={excelchatHeader} />
<CodeView transparentBackground codeText={excelchatLoginHeader} />
<CodeView transparentBackground codeText={excelchatWorkspaceHeader} />
