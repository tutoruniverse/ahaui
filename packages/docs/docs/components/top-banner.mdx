...
import StbTopBannerStructure1 from "@site/assets/structure/stb_top-banner-structure.jpg";
import StbTopBannerStructure2 from "@site/assets/structure/stb_top-banner-structure@2x.jpg";
...
<img
  src={StbTopBannerStructure1}
  srcSet={`${StbTopBannerStructure2} 2x`}
...
<ComponentApi name="TopBanner" importName="TopBanner" />
