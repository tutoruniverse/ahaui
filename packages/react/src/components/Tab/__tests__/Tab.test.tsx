...
describe('components/Tab', () => {
  ...
  const tabItemRef1 = createRef<HTMLButtonElement>();
  const tabItemRef2 = createRef<HTMLSpanElement>();
  ...
  const setup = (tabProps = {}, itemProps1 = {}, itemProps2 = {}) => {
    render(
      <Tab {...tabProps} ref={tabRef}>
        <Tab.Item {...itemProps1} ref={tabItemRef1} as="button">
          Item 1
        </Tab.Item>
        <Tab.Item {...itemProps2} ref={tabItemRef2} as="span">
          Item 2
        </Tab.Item>
      </Tab>,
    );
