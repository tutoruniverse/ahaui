...
const BubbleChat = React.forwardRef(
  (
    {
      className,
      isTyping,
      ...
      <>
        ...
        <div
          className={classNames(
            'BubbleChat-time',
            'u-text100 u-textGray u-marginTopTiny',
            type === 'inbound' && children && 'u-textRight',
            type === 'inbound' && 'u-justifySelfEnd',
          )}
        >
          {time}
        </div>
      ...
      <div className="u-flex u-flexColumn u-border u-borderUltraLight u-roundedBottomExtraLarge u-text200 u-overflowHidden">
        {options.map((option, idx) => {
          ...
          if (option.id === currentOption) {
            ...
            cn =
              'u-backgroundWhite hover:u-backgroundLightest u-textPrimary u-cursorPointer';
          ...
          return (
            <button
              ...
              className={classNames(
                ...
                idx !== 0
                  ? 'u-borderTop u-borderBottomNone u-borderLeftNone u-borderRightNone u-borderUltraLight'
                  : 'u-borderNone',
                cn,
              )}
            >
    ...
    return (
      <Context.Provider value={context}>
        <div
          ...
          {...props}
          className={classNames(
            'BubbleChat u-positionRelative u-inlineBlock',
            'u-marginBottomSmall',
            type !== 'inbound'
              ? 'u-marginRightExtraLarge'
              : 'u-marginLeftExtraLarge u-widthFull',
            className && className,
          )}
        >
          <div
