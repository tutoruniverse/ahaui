...
import { Omit, PrefixProps } from 'interfaces/helpers';
...
export function transitionEndListener(element: HTMLElement, handler: (e: TransitionEvent) => void) {
