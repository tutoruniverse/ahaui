...
import { VariantColorsEnum, VariantColors, PolymorphicComponentPropsWithRef, PolymorphicRef } from 'types/common';
...
const containTextClassNameVariants = [
  'primary', 'primary_subtle', 'accent', 'accent_subtle',
];
...
export const Tag: TagComponent = React.forwardRef(<T extends React.ElementType>(
  {
    ...
    as,
    ...props
  }: TagProps<T>, ref: PolymorphicRef<T>) => {
