...
export default class DateInput extends PureComponent {
  ...
  onValidatingValues = (formElements) => {
    let isValid = true;
    formElements.forEach((formElement) => {
      // eslint-disable-next-line react/destructuring-assignment
      if (this.state[formElement.name] === '') isValid = false;
      // eslint-disable-next-line react/destructuring-assignment
      if ((parseInt(this.state[formElement.name]) > parseInt(formElement.max)) || parseInt(this.state[formElement.name]) < parseInt(formElement.min)) isValid = false;
    });
    return isValid;
  }
  ...
  onChangeExternal = () => {
    ...
    onChange(processedValue, false, this.onValidatingValues(formElements));
  }
