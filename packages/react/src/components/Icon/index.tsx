...
const Icon: AhaRefForwardingComponent<'svg', IconProps> = React.forwardRef(
  (
    {
      className,
      path,
    ...
    <svg
      ...
      className={classNames(`${name}-icon u-inlineBlock`, className && className)}
      viewBox="0 0 24 24"
...
const IconWithDisplayName = Object.assign(Icon, {
  displayName: 'Icon',
});
