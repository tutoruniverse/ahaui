...
export const ToastContainer: AhaRefForwardingComponent<React.ElementType, ToastProps> = React.forwardRef(
  (
    {
...
const ToastContainerWithDisplayName = Object.assign(ToastContainer, {
  displayName: 'ToastContainer',
});

export default ToastContainerWithDisplayName;
