...
// Ref: https://github.com/mui/material-ui/blob/master/packages/mui-utils/src/useIsFocusVisible.ts
 ...
 * @returns {boolean}
 */
export function focusTriggersKeyboardModality(node: Element) {
...
export interface UseIsFocusVisibleResult {
  ...
  isFocusVisible: (event: React.FocusEvent) => boolean;
  handleBlurVisible: (event?: React.FocusEvent) => void;
