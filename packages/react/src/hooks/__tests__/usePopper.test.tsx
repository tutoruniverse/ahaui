...
const spyCreatePopper = jest.spyOn(Popper, 'createPopper');

describe('hooks/usePopper', () => {
  ...
  beforeEach(() => {
    ...
    spyCreatePopper.mockImplementation(() => ({
      destroy: mockDestroy,
      update: mockUpdate,
  ...
  it('should unmount correctly on not-exist popper', () => {
    // Test for the undefined popper current
    spyCreatePopper.mockImplementation(() => undefined as unknown as Popper.Instance);
